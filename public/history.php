                    ...
                    <table class="min-w-full divide-y divide-slate-200 dark:divide-slate-700">
                        <thead class="bg-slate-50 dark:bg-slate-900/50">
                            <tr>
                                ...
                                <th scope="col" class="px-6 py-3 text-center text-xs font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider">Actions</th>
                            </tr>
                        </thead>
                                ...
                                <tr class="hover:bg-slate-50 dark:hover:bg-slate-700/50 transition-colors duration-200">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-center text-sm font-medium">
                                        <div class="flex items-center justify-center space-x-4 h-full">
                                            ...
                                            <?php if($can_view_all): ?>
                                            <a href="ipcr.php?uid=<?= $row['emp_id'] ?>&period_id=<?= $row['period_id'] ?>" class="text-indigo-600 hover:text-indigo-900 dark:text-indigo-400 dark:hover:text-indigo-300 font-bold hover:underline flex items-center transition">
                                                Edit
                                                <svg class="ml-1 h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" /></svg>
                                            </a>
                                            <?php endif; ?>

                                            <a href="print_ipcr.php?period_id=<?= $row['period_id'] ?><?= $can_view_all ? '&uid=' . $row['emp_id'] : '' ?>" target="_blank" class="text-blue-600 hover:text-blue-900 dark:text-blue-400 dark:hover:text-blue-300 font-bold hover:underline flex items-center transition">
                                                View Copy
                                            ...
                                            <button onclick="openDeleteHistoryModal(<?= $row['period_id'] ?>, '<?= $period_text ?>', <?= $target_emp_id ?>)" class="text-red-500 hover:text-red-700 dark:text-red-400 dark:hover:text-red-300 font-bold transition flex items-center cursor-pointer">
                                                Delete
